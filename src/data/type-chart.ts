...
// Complete 18-type chart (Normal through Fairy = 18 types)
// Note: the plan says 19 types but standard Pokemon has 18 (Gen 6+)
// Effectiveness: 2 = super effective, 0.5 = not very effective, 0 = immune, 1 = neutral
...
/**
 * Get type effectiveness multiplier for an attacking type vs defending types
 */
